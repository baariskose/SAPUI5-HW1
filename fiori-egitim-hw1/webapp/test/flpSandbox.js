		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "homework",
									"targetURL": "#fioriegitimhw1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fioriegitimhw1-display": {
								"semanticObject": "fioriegitimhw1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriegitimhw1",
									"url": sap.ui.require.toUrl("fioriegitimhw1")
								}
							}
						}
					}
